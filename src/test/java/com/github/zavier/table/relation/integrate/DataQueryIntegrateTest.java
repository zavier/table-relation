...
public class DataQueryIntegrateTest {
    ...
    private void initData() {
        ...
        final ColumnRelation columnRelation3 = new ColumnRelation(col5, col6);
        ...
        final ColumnRelation columnRelation4 = new ColumnRelation(col7, col8);
        ...
        final ColumnRelation columnRelation5 = new ColumnRelation(col9, col10);
        ...
        final ColumnRelation columnRelation6 = new ColumnRelation(col11, col12);
